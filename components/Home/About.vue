<template>
    <div class="px-[10%] mt-[-100px] space-y-10 pb-8 bg-[url('/assets/image/background/vt-8.png')] bg-no-repeat bg-center">
        ...
        <p class="text-white md:text-lg md:w-[80%] mx-auto text-justify md:text-center tracking-widest capitalize sm:scroll-animation">
            ...
            development. which allow me to design and develop visually appealing and
            highly functional websites. I am particularly passionate about working with
            small businesses, as I find joy in using my skills to help them establish
